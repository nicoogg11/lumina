...
export class SkeletonComponent {
    ...
    ngAfterViewInit() {
        ...
        if (el) {
            ...
            this.resizeObserver = new ResizeObserver(entries => {
                ...
                if (r && r.height > 0)
                    this.containerHeight = Math.round(r.height);
                this.updateBones();
                this.cdr.markForCheck();
            });
     ...
     */
    injectKeyframes() {
        if (this.buildMode || this.keyframeStyle)
            return;
    ...
    get visibleBones() {
        return (this.activeBones?.bones ?? []).filter(raw => !normalizeBone(raw).c);
    }
    getBoneStyle(raw, index = 0) {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.8", ngImport: i0, type: SkeletonComponent, deps: [{ token: i0.ChangeDetectorRef }, { token: i0.ElementRef }], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.8", type: SkeletonComponent, isStandalone: true, selector: "boneyard-skeleton", inputs: { loading: "loading", name: "name", initialBones: "initialBones", color: "color", darkColor: "darkColor", animate: "animate", stagger: "stagger", transition: "transition", boneClass: "boneClass", cssClass: "cssClass", snapshotConfig: "snapshotConfig", select: "select" }, viewQueries: [{ propertyName: "containerRef", first: true, predicate: ["container"], descendants: true }], usesOnChanges: true, ngImport: i0, template: `
    <div
      #container
      [class]="cssClass"
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.8", ngImport: i0, type: SkeletonComponent, decorators: [{
  ...
  `,
        ...
        }], ctorParameters: () => [{ type: i0.ChangeDetectorRef }, { type: i0.ElementRef }], propDecorators: { loading: [{
                type: Input
            }], name: [{
                type: Input
            }], initialBones: [{
